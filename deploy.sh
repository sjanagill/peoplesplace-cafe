...
scp -i "C:/Users/sjanagill/Documents/PP_Demo.pem" execute_commands_on_ec2.sh ec2-user@ec2-18-169-2-189.eu-west-2.compute.amazonaws.com:/home/ec2-user
echo "Copied latest 'execute_commands_on_ec2.sh' file from local machine to ec2 instance"

scp -i "C:/Users/sjanagill/Documents/PP_Demo.pem" target/peoplesplace-cafe-0.0.1-SNAPSHOT.jar ec2-user@ec2-18-169-2-189.eu-west-2.compute.amazonaws.com:/home/ec2-user
...
ssh -i "C:/Users/sjanagill/Documents/PP_Demo.pem" ec2-user@ec2-18-169-2-189.eu-west-2.compute.amazonaws.com ./execute_commands_on_ec2.sh